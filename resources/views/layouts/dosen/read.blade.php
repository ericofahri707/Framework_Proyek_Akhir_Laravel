      ...
      <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('store-dosen')}}">
       @csrf
        <div class="form-group">
          <label>NIP</label>
          <input type="text" id="nip" name="nip" class="form-control" required="" value={{ $data->nip }}>
        </div>
        <div class="form-group">
          <label>Nama</label>
        ...
        <div class="form-group">
          ...
          <input type="text" id="no_telpon" name="no_telpon" class="form-control" required="" value={{$data->no_telpon}}>
        </div>
        <div class="form-group">
            <label>Alamat</label>
